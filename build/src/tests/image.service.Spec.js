...
describe('Testing image service', function () {
    it('Return the correct image if provide the correct name of image', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expectAsync((0, image_service_1.resizeImage)('HoChiMinh', 200, 200)).toBeResolved()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
